...
const form = useForm({
  ...
  latitude: props.strandedIncident.latitude || 9.57849189779755,
  longitude: props.strandedIncident.longitude || 123.74536514282228,
...
const hasChanges = computed(() => {
    ...
    const dataChanged = Object.keys(currentData).some((key) => {
        ...
        if (key === 'is_dangerous') {
            return currentData[key] !== !!props.strandedIncident[key];
        }
            ...
            <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <input id="quantity" type="number" v-model="form.quantity" class="w-full" required/>
